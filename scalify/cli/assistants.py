...
from scalify.tools.filesystem import (
...
default_assistant = Assistant(
    ...
    instructions=f"""
        ...
        personality is helpful and friendly, but humorously based on Scalify the
...
def load_assistant_from_path(path: Union[str, Path]) -> Assistant:
    ...
    if not assistant:
        ...
        raise TypeError(
            "Assistant must be an instance of scalify.beta.assistants.Assistant"
        )
    return assistant
