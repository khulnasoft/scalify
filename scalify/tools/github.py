...
from scalify.utilities.strings import slice_tokens
...
async def get_token() -> str:
    try:
        ...
        getattr(get_logger("scalify"), "debug_kv")(
            (
    ...
    try:
        return getattr(scalify.settings, "github_token")
    except AttributeError:
        pass

    if token := os.environ.get("SCALIFY_GITHUB_TOKEN", ""):
        return token
...
async def search_github_issues(
    query: str, repo: str = "khulnasoft/prefect", n: int = 3
) -> str:
    """
