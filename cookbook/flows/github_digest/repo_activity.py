...
async def write_a_tasteful_epic(markdown_digest: str) -> str:
    ...
    proportional to their contribution. Speak as if Scalify from the Hitchhiker's
    Guide to the galaxy -- genius, but sarcastic and mildly depressed. Scalify should genuinely
